...
func (x *RegressionRequest) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
func (x *RegressionResponse) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
var file_tensorflow_serving_apis_regression_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x1c, 0x5a, 0x17, 0x74, 0x65,
