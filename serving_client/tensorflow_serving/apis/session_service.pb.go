...
func (x *SessionRunRequest) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
type SessionRunResponse struct {
	...
	ModelSpec *model.ModelSpec `protobuf:"bytes,3,opt,name=model_spec,json=modelSpec,proto3" json:"model_spec,omitempty"`
...
func (x *SessionRunResponse) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
var file_tensorflow_serving_apis_session_service_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x1c, 0x5a, 0x17, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5f,
...
var file_tensorflow_serving_apis_session_service_proto_goTypes = []interface{}{
	...
	(*model.ModelSpec)(nil),                           // 2: tensorflow.serving.ModelSpec
