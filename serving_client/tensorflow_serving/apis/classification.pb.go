...
func (x *ClassificationRequest) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
func (x *ClassificationResponse) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
var file_tensorflow_serving_apis_classification_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x42, 0x1c, 0x5a, 0x17, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c,
...
var file_tensorflow_serving_apis_classification_proto_goTypes = []interface{}{
	...
	(*model.ModelSpec)(nil),        // 5: tensorflow.serving.ModelSpec
