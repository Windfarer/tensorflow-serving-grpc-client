...
func (x *InferenceTask) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
func (x *InferenceResult) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
var file_tensorflow_serving_apis_inference_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x42, 0x1c,
	0x5a, 0x17, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x73, 0x65, 0x72,
