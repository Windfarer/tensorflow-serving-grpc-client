...
import (
	...
	reflect "reflect"
	sync "sync"
	model "tensorflow_serving/apis/model"
)
...
type PredictRequest struct {
	...
	// (numerical) version.
	ModelSpec *model.ModelSpec `protobuf:"bytes,1,opt,name=model_spec,json=modelSpec,proto3" json:"model_spec,omitempty"`
	// Input tensors.
...
func (x *PredictRequest) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
type PredictResponse struct {
	...
	ModelSpec *model.ModelSpec `protobuf:"bytes,2,opt,name=model_spec,json=modelSpec,proto3" json:"model_spec,omitempty"`
	// Output tensors.
...
func (x *PredictResponse) GetModelSpec() *model.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
var file_tensorflow_serving_apis_predict_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x1c, 0x5a,
	0x17, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x73, 0x65, 0x72, 0x76,
...
var file_tensorflow_serving_apis_predict_proto_goTypes = []interface{}{
	...
	(*model.ModelSpec)(nil),             // 4: tensorflow.serving.ModelSpec
